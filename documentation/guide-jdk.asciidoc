...
OpenJDK maintains a specific major version of Java for six months before moving to the next major version. This technically means that OpenJDK can not be used in production software projects, what typically need a stable version over a far longer time window.
...
|`javax.xml.bind.*`   |`javax.xml.bind`    |`jaxb-api`             |`2.3.0`
|`com.sun.xml.bind.*` |`com.sun.xml.bind`  |`jaxb-impl`            |`2.3.0`
